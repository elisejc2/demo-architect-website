...
function openModal(project) {
    ...
    for (let i = 0; i < carouselImageEls.length; i++) {
        ...
        const { image, title, overview, designed, text } = currentPrjItem; // Shorthand for currentPrjItem.image and currentPrjItem.text ... this is called "object destructuring"
